      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            ...
            <h3 className="text-lg font-semibold text-white-500 mb-2">About Us</h3>
            <p className="text-gray-500">We want to help bring  unique startups together.</p>
            <h3 className="text-lg font-semibold text-white-500 mt-4 mb-2">Contact Us</h3>
          ...
          {/* Information */}
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            <h3 className="text-lg font-semibold text-white-500 mb-4">Information</h3>
            <ul>
          ...
          {/* Helpful Links */}
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            <h3 className="text-lg font-semibold text-white-500 mb-4">Helpful Links</h3>
            <ul>
          ...
          <div className="w-full md:w-1/4">
            <h3 className="text-lg font-semibold text-white-500 mb-4">Subscribe More Info</h3>
            <div className="flex">
              <input
                type="email"
              ...
              />
              <button className="bg-white-500 text-black p-2 rounded-r-md">Subscribe</button>
            </div>
          </div>
        </div>
